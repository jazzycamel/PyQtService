...
if __name__=="__main__":
    ...
    parser=ArgumentParser(description="Configure PyQtService module.")
    parser.add_argument(
        '-q', '--qmake',
        dest="qmake",
        type=str,
    ...
    makefile.extra_defines+=['QT_QTSERVICE_EXPORT', 'QT_CORE_LIB']#, 'QT_GUI_LIB', 'QT_WIDGETS_LIB']
    ...
    os.chdir("src")    
    qmake_cmd=qmake_exe
    if sys.platform=="win32": qmake_cmd+=" -spec win32-msvc2015"
    print()
    print(qmake_cmd)
    os.system(qmake_cmd)
    sys.exit()